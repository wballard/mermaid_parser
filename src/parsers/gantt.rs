use crate::common::ast::{
    AccessibilityInfo, GanttDiagram, GanttSection, GanttTask, TaskStatus, Weekday,
    WeekdaySettings,
};
...
fn gantt_lexer<'src>() -> impl Parser<'src, &'src str, Vec<GanttToken>, extra::Err<Simple<'src, char>>> {
