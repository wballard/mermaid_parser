...
fn journey_lexer<'src>() -> impl Parser<'src, &'src str, Vec<JourneyToken>, extra::Err<Simple<'src, char>>> {
...
"#;
        ...
        assert!(result.is_ok(), "Failed to parse simple journey: {:?}", result);
