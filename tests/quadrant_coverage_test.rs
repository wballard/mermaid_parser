...
fn test_accessibility_with_space_syntax() {
    ...
    assert_eq!(diagram.accessibility.title, Some("Test Accessibility Title".to_string()));
    assert_eq!(diagram.accessibility.description, Some("Test accessibility description".to_string()));
}
...
fn test_quadrant_labels_all_variants() {
    ...
    assert_eq!(diagram.quadrants.quadrant_1, Some("First Quadrant".to_string()));
    assert_eq!(diagram.quadrants.quadrant_2, Some("Second Quadrant".to_string()));
    assert_eq!(diagram.quadrants.quadrant_3, Some("Third Quadrant".to_string()));
    assert_eq!(diagram.quadrants.quadrant_4, Some("Fourth Quadrant".to_string()));
}
...
fn test_comprehensive_quadrant_diagram() {
    ...
    assert_eq!(diagram.accessibility.title, Some("Full Accessibility Title".to_string()));
    assert_eq!(diagram.accessibility.description, Some("Complete accessibility description".to_string()));
    
    assert!(diagram.x_axis.is_some());
    assert!(diagram.y_axis.is_some());
    
    assert_eq!(diagram.quadrants.quadrant_1, Some("Quick Wins".to_string()));
    assert_eq!(diagram.quadrants.quadrant_2, Some("Major Projects".to_string()));
    assert_eq!(diagram.quadrants.quadrant_3, Some("Fill-ins".to_string()));
    assert_eq!(diagram.quadrants.quadrant_4, Some("Thankless Tasks".to_string()));
