...
"#;
    ...
    assert_eq!(diagram.quadrants.quadrant_2, Some("Need to promote".to_string()));
    assert_eq!(diagram.quadrants.quadrant_3, Some("Re-evaluate".to_string()));
    assert_eq!(diagram.quadrants.quadrant_4, Some("May be improved".to_string()));
...
"#;
    ...
    assert_eq!(diagram.accessibility.description, Some("This is an accessible description".to_string()));
}
